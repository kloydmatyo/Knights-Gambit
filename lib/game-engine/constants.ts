...
export const WEAPON_UPGRADES = [
  ...
  {
    id: 'knight_advanced_c',
    name: 'Armor Breaker',
    description: '+6 ATK, +5 Armor Pen — Shatter enemy defenses.',
    tier: 'advanced',
    requiredClass: 'knight',
    requiredFloor: 4,
    cost: 120,
    effect: { attackBonus: 6, armorPenBonus: 5 },
    prerequisiteId: 'knight_basic',
    emoji: '💥',
  },
  {
  ...
  {
    id: 'archer_advanced_c',
    name: 'Piercing Bolts',
    description: '+5 ATK, +8 Armor Pen — Arrows that ignore armor.',
    tier: 'advanced',
    requiredClass: 'archer',
    requiredFloor: 4,
    cost: 120,
    effect: { attackBonus: 5, armorPenBonus: 8 },
    prerequisiteId: 'archer_basic',
    emoji: '🎯',
  },
  {
  ...
  // ─── MAGE ─────────────────────────────────────────────────────────────────
  {
    ...
    description: '+4 ATK, +10 HP, +10 MP — Arcane energy flows through the wood.',
    tier: 'basic',
    requiredClass: 'mage',
    requiredFloor: 1,
    cost: 60,
    effect: { attackBonus: 4, healthBonus: 10, manaBonus: 10 },
    emoji: '🪄',
  },
  {
    id: 'mage_advanced_a',
    name: 'Spellweaver\'s Orb',
    description: '+7 ATK, +10% crit chance, +15 MP — Spells detonate with arcane force.',
    tier: 'advanced',
    requiredClass: 'mage',
    requiredFloor: 3,
    cost: 100,
    effect: { attackBonus: 7, critChanceBonus: 0.1, manaBonus: 15 },
  ...
  },
  {
    id: 'mage_advanced_b',
    name: 'Runic Tome',
    description: '+5 ATK, +30 HP, +15 MP — Ancient runes bolster your constitution.',
    tier: 'advanced',
    requiredClass: 'mage',
    requiredFloor: 3,
    cost: 100,
    effect: { attackBonus: 5, healthBonus: 30, manaBonus: 15 },
    prerequisiteId: 'mage_basic',
    emoji: '📖',
  },
  {
    id: 'mage_advanced_c',
    name: 'Mana Crystal',
    description: '+20 MP — Expand your arcane reservoir.',
    tier: 'advanced',
    requiredClass: 'mage',
    requiredFloor: 3,
    cost: 100,
  ...
  },
  {
    id: 'mage_advanced_d',
    name: 'Void Shard',
    description: '+6 ATK, +6 Armor Pen — Magic that erodes all defenses.',
    tier: 'advanced',
    requiredClass: 'mage',
    requiredFloor: 4,
    cost: 120,
    effect: { attackBonus: 6, armorPenBonus: 6 },
    prerequisiteId: 'mage_basic',
    emoji: '🌀',
  },
  {
    ...
    description: '+12 ATK, +20% crit dmg, +20 MP — Spells pierce magical resistance.',
    tier: 'elite',
    requiredClass: 'mage',
    requiredFloor: 6,
    cost: 160,
    effect: { attackBonus: 12, critDamageBonus: 0.2, manaBonus: 20 },
  ...
  },
  {
    ...
    description: '+22 ATK, +40% crit dmg, +20 HP, +30 MP — The universe bends to your will.',
    tier: 'legendary',
    requiredClass: 'mage',
    requiredFloor: 9,
    cost: 250,
    effect: { attackBonus: 22, critDamageBonus: 0.4, healthBonus: 20, manaBonus: 30, specialAbility: 'arcane_nova' },
  ...
  {
    id: 'barbarian_advanced_c',
    name: 'Sunder Maul',
    description: '+8 ATK, +7 Armor Pen — Crush through any defense.',
    tier: 'advanced',
    requiredClass: 'barbarian',
    requiredFloor: 4,
    cost: 120,
    effect: { attackBonus: 8, armorPenBonus: 7 },
    prerequisiteId: 'barbarian_basic',
    emoji: '⚡',
  },
  {
  ...
  {
    id: 'assassin_advanced_c',
    name: 'Vital Strike',
    description: '+5 ATK, +6 Armor Pen — Find the gaps in their armor.',
    tier: 'advanced',
    requiredClass: 'assassin',
    requiredFloor: 4,
    cost: 120,
    effect: { attackBonus: 5, armorPenBonus: 6 },
    prerequisiteId: 'assassin_basic',
    emoji: '🎯',
  },
  {
  ...
  {
    id: 'cleric_advanced_c',
    name: 'Sanctified Warhammer',
    description: '+6 ATK, +5 Armor Pen — Holy might shatters evil.',
    tier: 'advanced',
    requiredClass: 'cleric',
    requiredFloor: 4,
    cost: 120,
